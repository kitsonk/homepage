  ...
  return (
    <>
      <Meta
        ...
        canonical="/resume-cv"
        keywords={["resume", "cv", "curriculum vitae", "kitson kelly"]}
      />
        ...
        <section class="py-8 border-b-2">
          ...
          >
            <p>
              ...
              provides consulting and technology delivery services to large IT organisations. As a Principal
          ...
          >
            <p>
              An approximately 30-person company focused on delivering enterprise web applications. I was responsible
              for leading software engineering and engaging with our clients on their architecture, digital
              transformation road-map, and engineering practices. I also lead our growth into more business consulting
              with a focus on helping large enterprises adopt open source methodologies to scale their enterprise
              development.
            </p>
            <p>
              ...
              with Microsoft's TypeScript language and have in depth knowledge of web technologies including the
              standards bodies that support them.
            </p>
          </Role>
          <Role
          ...
          >
            ...
            <p>
              ...
              allowed me to understand the challenges facing my teams better as well as guide the business in a
              direction where technology was an enabler, not a barrier.
            </p>
            <p>
              NOW was very demanding, because of the low friction to join meant that there was also low fiction to
              leave. It really highlighted to me the challenges of operating a digital business and the key role
          ...
          >
            <p>
              ...
              of my earlier work. In additional to technical expertise, there was need for organisational design to
              build an internal team at Sky which could effectively manage the large, complex contact centre solution.
            </p>
          </Role>
          <Role
          ...
          >
            <p>
              I joined eLoyalty as a Consultant and continued to grow into more senior roles. I wanted to travel
              globally, and I was put on projects in varied locations across the US and Hong Kong, Hamburg, Belfast,
              Paris, and Dublin. I touched most technologies that were present in customer contact centres, though my
              main specialty was large scale global call routing solutions.
            </p>
          </Role>
